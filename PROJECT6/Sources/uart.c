...
void uart_channel_init(int p_n, int p_baud_rate, parity p_parity, bits_per_character p_bits, stop_bits p_stop_bits,
	...
	*/
	...
	//int x = p_baud_rate; ----------------------------------- to compile PRJ6
	//UGB1 MSB of Divider
	...
	//int int_src = 13 + p_n;  ----------------------------------- to compile PRJ6
	//int_config(int_src, p_level, p_priority, uart1_isr);  ----------------------------------- to compile PRJ6
	//int_unmask_src(int_src);  ----------------------------------- to compile PRJ6
